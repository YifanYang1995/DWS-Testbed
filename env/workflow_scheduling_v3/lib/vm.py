...
class VM:
    def __init__(self, id, cpu, dcind, abind, t, rule):
        ...
        self.currentTimeStep = t  # Time when self.processingtask finishes.
        self.rentStartTime = t
        self.rentEndTime = t        # Latest scheduled finish time.
        ...
        self.pendingTaskTime = 0    # Total pending time excluding self.processingtask.
    ...
    def get_taskFinishTime(self, task, app):
        # self.currentTimeStep can be set even when no task is currently processing.
